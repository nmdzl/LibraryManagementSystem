class LibrariansController < ApplicationController
  ...
  # GET /librarians.json
  def index
    @librarians = Librarian.all.paginate(:per_page=>10, :page=>params[:page])
  end
  ...
  private
    ...
    def librarian_params
      params.require(:librarian).permit(:name, :email, :password, :password_confirmation, :library_id ) #:librarian
    end
end
